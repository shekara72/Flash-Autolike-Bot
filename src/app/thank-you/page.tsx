  ...
  if (loading) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-[#0B0B0F] text-gray-500">
        ...
        <p className="font-bold text-sm">Processing order confirmation...</p>
      </div>
    );
  }
    ...
    <div className="flex min-h-screen flex-col bg-[#0B0B0F] text-white">
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-16">
        <div className="glass-card w-full max-w-xl p-8 md:p-12 bg-[#16161F] border-[rgba(255,255,255,0.06)] shadow-2xl text-center relative overflow-hidden">
          ...
          <h1 className="text-3xl font-black text-white tracking-tight uppercase">Payment Successful!</h1>
          <p className="mt-2.5 text-xs text-gray-400 font-semibold uppercase">Your subscription is now activated. Thank you for choosing Flash Autolike Bot.</p>
