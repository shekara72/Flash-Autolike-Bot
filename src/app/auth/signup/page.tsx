...
export default function SignupPage() {
  ...
  useEffect(() => {
    // Redirect to login page where passwordless UID signup is handled automatically
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F] text-white flex items-center justify-center p-6">
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <p className="text-xs uppercase font-bold text-gray-500 tracking-wider">Redirecting to login pipeline...</p>
      </div>
    </div>
  );
}
